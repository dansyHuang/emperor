...
import com.jing.emperor.domain.car.service.impl.EmpCarOrderDetailDomainServiceImpl;
import com.jing.emperor.domain.car.service.impl.EmpCarOrderDomainServiceImpl;
...
public class EmpCarOrderDetailController {
	...
	public ResultModel<String> createEmpCarOrderDetail(@RequestBody @Valid CreateEmpCarOrderDetailVo record){
		...
		try {
			...
			String id=empCarOrderDetailDomainService.saveEmpCarOrderDetail(record,pvg);
			result.setValue(id);
